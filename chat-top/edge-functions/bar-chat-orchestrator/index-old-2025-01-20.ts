...
// Data: 2025-01-12
// BACKUP: 2025-01-20 - Versione funzionante con TTS prima fix risposta simultanea
...
serve(async (req) => {
  ...
  try {
    ...
    if (voiceEnabled && elevenLabsKey && elevenLabsVoiceId) {
      ...
      if (voiceEnabled) {
        console.warn('⚠️ Voice enabled ma parametri mancanti:', {
    ...
    console.error('❌ Errore Bar Chat Orchestrator:', error);

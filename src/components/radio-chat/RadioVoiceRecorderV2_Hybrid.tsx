...
interface RadioVoiceRecorderV2Props {
  conversationId: string;
  onTranscriptionComplete: (text: string) => void;
  isDisabled?: boolean;
}

export const RadioVoiceRecorderV2_Hybrid = ({
  conversationId,
  onTranscriptionComplete,
  isDisabled = false
}: RadioVoiceRecorderV2Props) => {
  const [isActive, setIsActive] = useState(false);
  const [isRecordingChunk, setIsRecordingChunk] = useState(false);
  ...
  const startListening = async () => {
    try {
      console.log('🎤 Radio V2_Hybrid: Modalità ascolto attivata');
  ...
  const stopListening = () => {
    console.log('🎤 Radio V2_Hybrid: Disattivazione completa');
    ...
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="flex items-center gap-3">
        <Button
          ...
          className="relative"
          title="🎤 HYBRID: Premi per attivare microfono sempre acceso. Auto-invio ogni pausa 1.5s."
        >

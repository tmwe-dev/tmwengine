...
export function RecordDetailLayout({ record, formatCellValue }: RecordDetailLayoutProps) {
  ...
  const handleCreateActivity = async (activityData: any) => {
    try {
      console.log('🔍 DEBUG handleCreateActivity - activityData:', activityData);
      console.log('🔍 DEBUG handleCreateActivity - record:', record);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-[-1px] z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-4 border-b shadow-sm">
        {/* Breadcrumb */}
        <div className="mb-3">
          <Breadcrumb>
            <BreadcrumbList>

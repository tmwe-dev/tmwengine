/**
 * MAIL PAGE TEMPLATE
 * Template pulito per costruire pagine email future
 * 
 * Struttura:
 * - Top bar: Navigazione, gestione gruppi mittenti, azioni
 * - Action bar: Reply, Reply All, Forward
 * - ScrollArea: Contenitore vuoto per contenuto email (oggetto, body, allegati)
 * - Sheet: Dialog per configurazione regole automatiche
 * 
 * Funzionalità incluse:
 * - Gestione gruppi mittenti
 * - Creazione regole automatiche per mittenti
 * - Navigazione tra email (prev/next)
 * - Auto-mark as read
 */
...
export const MailPageTemplate = ({ 
  ...
  return (
    <div className="flex h-full flex-col bg-card-transparent">
      ...
      {/* CONTENT AREA - Add your email content here */}
      <ScrollArea className="flex-1">
        {/* TODO: Add email subject, body, attachments, etc. */}
      </ScrollArea>

      {/* Automatic rules configuration sheet */}

      ...
      {emails.map((email, index) => (
        <Card
          ...
          className={cn(
            ...
            email.read 
              ? 'border-l-transparent hover:shadow-[-6px_6px_16px_0px_rgba(216,180,254,0.4)] hover:scale-[1.01]'
              : 'border-l-orange-500/50 hover:shadow-[-6px_6px_16px_0px_rgba(253,186,116,0.45)] hover:scale-[1.01]',

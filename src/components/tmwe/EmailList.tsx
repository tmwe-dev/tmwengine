        ...
        {emails.map((email, index) => (
          <Card
            ...
            className={cn(
              ...
              email.read 
                ? 'border-l-transparent shadow-[-4px_4px_12px_0px_rgba(216,180,254,0.3)] hover:shadow-[-6px_6px_16px_0px_rgba(216,180,254,0.4)] hover:scale-[1.02]'
                : 'border-l-orange-500/50 shadow-[-4px_4px_12px_0px_rgba(253,186,116,0.35)] hover:shadow-[-6px_6px_16px_0px_rgba(253,186,116,0.45)] hover:scale-[1.02]',
              selectedEmailId === email.id && (
                email.read 
                  ? 'shadow-[-6px_6px_16px_0px_rgba(216,180,254,0.5)] border-purple-500/30 scale-[1.02]'
                  : 'shadow-[-6px_6px_16px_0px_rgba(253,186,116,0.55)] border-orange-500/50 scale-[1.02]'
              )
            )}

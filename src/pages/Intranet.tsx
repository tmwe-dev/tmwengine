        ...
        <div className={`flex-1 ${shouldHideHeader ? `flex ${isLayoutInverted ? 'flex-col-reverse' : 'flex-col'} h-full overflow-hidden min-h-0 transition-all duration-300` : 'relative flex flex-col overflow-hidden space-y-6'}`}>
          ...
          {selectedRoomId ? (
            <>
              ...
              <Card className={`bg-card-transparent ${shouldHideHeader ? 'border-0 shadow-none flex-shrink-0 max-h-[240px] overflow-hidden flex flex-col' : ''}`}>
                <CardContent className={shouldHideHeader ? 'p-0 flex-1' : 'p-3 sm:p-6'}>

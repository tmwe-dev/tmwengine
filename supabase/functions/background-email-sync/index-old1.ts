// ============================================
// BACKUP PRE-FIX: data.messages extraction
// Data: 2025-01-29
// File Originale: supabase/functions/background-email-sync/index.ts
// Motivo: Backup PRIMA del fix getFolderUIDs() - cambio da data.data a data.messages
// ============================================

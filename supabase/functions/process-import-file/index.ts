...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Saving file for processing:', { filePath, fileName });
    ...
    console.log(`Detected separator: "${separator}", headers: ${headers.length}`);
    ...
    console.log(`File saved successfully. Rows: ${totalRows}, Headers: ${headers.length}`);
    ...
    return new Response(JSON.stringify({
      ...
      data: {
        ...
        separator,
        message: 'File salvato e pronto per elaborazione'
      }
    }), {

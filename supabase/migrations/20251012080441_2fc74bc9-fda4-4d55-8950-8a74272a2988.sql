...
-- 1.3 Token tracking per intranet_rooms
...
DROP POLICY IF EXISTS "Users can view own conversation chunks" ON document_chunks;
...
DROP POLICY IF EXISTS "Users can view own costs" ON ai_cost_tracking;
DROP POLICY IF EXISTS "System can track costs" ON ai_cost_tracking;
